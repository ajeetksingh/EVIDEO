...
(function ($) {
    ...
    // } else {
        ...
        style = '._vp_widget{ width: 400px;} .vp_header{ width:100%; text-align:right; background-color:#FFE4C4; border:1px solid gray; text-align:center}.vp_footer{ width:100%; text-align:right; background-color :#FFE4C4; border:1px solid gray}.vp_footer a{margin-right:5px;color:#A01A1A}.vp_list{ float:left; text-align:left; border:1px solid gray; background-color:white; width:100%; overflow:auto; position: relative}.vp_lst_even{background-color:white;padding:4px}.vp_lst_odd{background-color:#FFE4C4;padding:4px;}.vp_lst_active{background-color:#787676}.vp_time{ position:absolute; margin:0 3px 0 0; right:0px; background-color:gray; width:45px; text-align:center; border:1px solid darkgrey; color:ghostwhite; text-decoration:none}';
	 style += '._vp_widget1{ width: 400px;} .vp_header{ width:100%; text-align:right; background-color:#FFE4C4; border:1px solid gray; text-align:center}.vp_footer{ width:100%; text-align:right; background-color:#FFE4C4; border:1px solid gray}.vp_footer a{margin-right:5px;color:#A01A1A}.vp_list{ float:left; text-align:left; border:1px solid gray; background-color:white; width:100%; overflow:auto; position: relative}.vp_lst_even{background-color:white;padding:4px}.vp_lst_odd{background-color:#FFE4C4;padding:4px;}.vp_lst_active{background-color:#787676}.vp_time{ position:absolute; margin:0 3px 0 0; right:0px; background-color:gray; width:45px; text-align:center; border:1px solid darkgrey; color:ghostwhite; text-decoration:none}';
	style += '._vp_widget2{ width: 400px;} .vp_header{ width:100%; text-align:right; background-color:#FFE4C4; border:1px solid gray; text-align:center}.vp_footer{ width:100%; text-align:right; background-color:#FFE4C4; border:1px solid gray}.vp_footer a{margin-right:5px;color:#A01A1A}.vp_list{ float:left; text-align:left; border:1px solid gray; background-color:white; width:100%; overflow:auto; position: relative}.vp_lst_even{background-color:white;padding:4px}.vp_lst_odd{background-color:#FFE4C4;padding:4px;}.vp_lst_active{background-color:#787676}.vp_time{ position:absolute; margin:0 3px 0 0; right:0px; background-color:gray; width:45px; text-align:center; border:1px solid darkgrey; color:ghostwhite; text-decoration:none}';
	...
	var value = new Array(v.id, v.time, v.title);
        var div = $('<div>').append($('<a>', {
            ...
            html: $('<span> <span class="vp_fns"></span><a style="float:right;color:#A01A1A;" href="javascript:editAnnotation('+v.id+');">Edit</a><a style="float:right;color:#ffffff" class="button1" href="javascript:deleteAnnotation('+v.id+');">X</a><p style="text-align:justify; width:23em;"><span class="vp_title" >'+v.title+'</span></span>').addClass( v.childrens ? 'expand sublist' : v.top ? 'vp_sub_list' : 'vp_entry')
        }).append($('<span>', {
            'class': 'vp_time',
    ...
    function make_title1(v) {
        ...
        var div = $('<div>').append($('<a>', {
            ...
            html: $('<span> <span class="vp_fns"></span>'+'<span class="vp_title" style="font-weight:bold;">'+v.title+'<a href="'+v.url+'" style="color:blue;" target="_blank">[View More]</a><a style="float:right;color:#A01A1A;" href="javascript:abc2('+v.id+');">Edit</a><a style="float:right;color:#ffffff;" class="button1" href="javascript:deleteLink('+v.id+');">X</a></span></span><p>'+v.description+'</p>').addClass( v.childrens ? 'expand sublist' : v.top ? 'vp_sub_list' : 'vp_entry')
        }).append($('<span>', {
            'class': 'vp_time',
            html: sec2norm(v.time)
        }))).css({'text-decoration':'none'}).data({
     ...
     function make_title2(v) {
        ...
        var div = $('<div>').append($('<a>', {
            ...
            html: $('<span> <span class="vp_fns"></span>'+'<span class="vp_title" style="font-weight:bold;">'+v.title+'<a style="float:right;color:#A01A1A;" href="javascript:abc3('+v.id+');">Edit</a><a style="float:right;color:#ffffff;" class="button1" href="javascript:deleteBookmark('+v.id+');">X</a></span></span><p>'+v.desc+'</p>').addClass( v.childrens ? 'expand sublist' : v.top ? 'vp_sub_list' : 'vp_entry')
        }).append($('<span>', {
            'class': 'vp_time',
	...
	//edited_Devanshu
        create_header: function (str) {
            return $('<div>', {
                id: 'vp_header',
                'class': 'vp_header',
                'html': '<a style="color:#ffffff" class="button1" href="javascript:abc()"><span>Add '+str+'</span></a>&nbsp;&nbsp;&nbsp;<a style="color:#A01A1A" href="http://medialab.iitj.ac.in">'+str+'</a>&nbsp;&nbsp;<a id="close" style="margin-left:125px;cursor:pointer;color:#ffffff" class="button1">Close</a>'
	...
	create_header1: function (str) {
            return $('<div>', {
                id: 'vp_header',
                'class': 'vp_header',
                'html': '<a class="button1" style="float:left;color:#ffffff;" href="javascript:abc1()"><span>Add '+str+'</span></a>&nbsp;&nbsp;&nbsp;<a style="color:#A01A1A" href="http://medialab.iitj.ac.in">'+str+'</a>&nbsp;&nbsp;<img id="close" style="margin-left:125px;cursor:pointer;" src="close_button.png">'
