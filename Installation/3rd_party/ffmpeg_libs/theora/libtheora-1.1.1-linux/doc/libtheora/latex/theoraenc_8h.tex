...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[out]} {\em $<$tt$>$char}]$\ast$\_\-buf: Returns a pointer to internal storage containing the two pass metrics data. This storage is only valid until the next call, or until the encoder context is freed, and must be copied by the application. \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[out]} {\em \_\-buf}]{\ttfamily int}: The current encoding speed level. 0 is slowest, larger values use less CPU. \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[out]} {\em \_\-buf}]{\ttfamily int}: The maximum encoding speed level. \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \_\-buf}]{\ttfamily long}: The new target bitrate, in bits per second. \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \_\-buf}]{\ttfamily int}: The number of duplicates to produce. If this is negative or zero, no duplicates will be produced. \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \_\-buf}]{\ttfamily \doxyref{th\_\-huff\_\-code}{p.}{structth__huff__code}[\doxyref{TH\_\-NHUFFMAN\_\-TABLES}{p.}{codec_8h_a49bf449eae33c5320f0c308f32c6ae42}][\doxyref{TH\_\-NDCT\_\-TOKENS}{p.}{codec_8h_a2a44f48084e76a58cae48fb5d47cd422}]} \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \_\-buf}]{\ttfamily ogg\_\-uint32\_\-t}: The maximum distance between key frames. \item[\mbox{\tt[out]} {\em \_\-buf}]{\ttfamily ogg\_\-uint32\_\-t}: The actual maximum distance set. \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \_\-buf}]{\ttfamily int}: The new target quality, in the range 0...63, inclusive. \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \_\-buf}]\doxyref{th\_\-quant\_\-info}{p.}{structth__quant__info} \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \_\-buf}]{\ttfamily int}: Requested size of the reservoir measured in frames. \item[\mbox{\tt[out]} {\em \_\-buf}]{\ttfamily int}: The actual size of the reservoir set. \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \_\-buf}]{\ttfamily int}: Any combination of \doxyref{the available flags}{p.}{theoraenc_8h_ratectlflags}:
\begin{DoxyItemize}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \_\-buf}]{\ttfamily int}: The new encoding speed level. 0 is slowest, larger values use less CPU. \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em \_\-buf}]{\ttfamily int}: a non-\/zero value to enable VP3 compatibility, or 0 to disable it (the default). \item[\mbox{\tt[out]} {\em \_\-buf}]{\ttfamily int}: 1 if all bitstream features required for VP3-\/compatibility could be set, and 0 otherwise. The latter will be returned if the pixel format is not 4:2:0, the picture region is smaller than the full frame, or if encoding has begun, preventing the quantization tables and codebooks from being set. \end{DoxyParams}
...
\index{theoraenc.h@{theoraenc.h}!TH\_\-VP31\_\-QUANT\_\-INFO@{TH\_\-VP31\_\-QUANT\_\-INFO}}
