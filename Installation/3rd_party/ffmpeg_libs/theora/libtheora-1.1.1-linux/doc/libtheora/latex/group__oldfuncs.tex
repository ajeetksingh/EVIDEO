...
\begin{DoxyCompactList}\small\item\em The libtheora pre-\/1.0 legacy C API. \item\end{DoxyCompactList}
...
\index{oldfuncs@{oldfuncs}!OC\_\-BADPACKET@{OC\_\-BADPACKET}}
...
\index{oldfuncs@{oldfuncs}!OC\_\-DISABLED@{OC\_\-DISABLED}}
...
\index{oldfuncs@{oldfuncs}!OC\_\-DUPFRAME@{OC\_\-DUPFRAME}}
...
\index{oldfuncs@{oldfuncs}!OC\_\-EINVAL@{OC\_\-EINVAL}}
...
\index{oldfuncs@{oldfuncs}!OC\_\-FAULT@{OC\_\-FAULT}}
...
\index{oldfuncs@{oldfuncs}!OC\_\-IMPL@{OC\_\-IMPL}}
...
\index{oldfuncs@{oldfuncs}!OC\_\-NEWPACKET@{OC\_\-NEWPACKET}}
...
\index{oldfuncs@{oldfuncs}!OC\_\-NOTFORMAT@{OC\_\-NOTFORMAT}}
...
\index{oldfuncs@{oldfuncs}!OC\_\-VERSION@{OC\_\-VERSION}}
...
\index{oldfuncs@{oldfuncs}!TH\_\-DECCTL\_\-GET\_\-PPLEVEL\_\-MAX@{TH\_\-DECCTL\_\-GET\_\-PPLEVEL\_\-MAX}}
...
Sets the level of post-\/processing to use when decoding the compressed stream. This must be a value between zero (off) and the maximum returned by TH\_\-DECCTL\_\-GET\_\-PPLEVEL\_\-MAX. \index{oldfuncs@{oldfuncs}!TH\_\-ENCCTL\_\-GET\_\-SPLEVEL\_\-MAX@{TH\_\-ENCCTL\_\-GET\_\-SPLEVEL\_\-MAX}}
...
\item[\mbox{\tt[out]} {\em buf}]int: The maximum encoding speed level. \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em buf}]{\ttfamily ogg\_\-uint32\_\-t}: The maximum distance between key frames. \item[\mbox{\tt[out]} {\em buf}]{\ttfamily ogg\_\-uint32\_\-t}: The actual maximum distance set. \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em buf}]\doxyref{th\_\-quant\_\-info}{p.}{structth__quant__info} \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em buf}]int: The new encoding speed level. 0 is slowest, larger values use less CPU. \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[\mbox{\tt[in]} {\em buf}]{\ttfamily int}: a non-\/zero value to enable VP3 compatibility, or 0 to disable it (the default). \item[\mbox{\tt[out]} {\em buf}]{\ttfamily int}: 1 if all bitstream features required for VP3-\/compatibility could be set, and 0 otherwise. The latter will be returned if the pixel format is not 4:2:0, the picture region is smaller than the full frame, or if encoding has begun, preventing the quantization tables and codebooks from being set. \end{DoxyParams}
...
\index{oldfuncs@{oldfuncs}!theora\_\-comment@{theora\_\-comment}}
\index{theora\_\-comment@{theora\_\-comment}!oldfuncs@{oldfuncs}}
...
\subsubsection[{theora\_\-decode\_\-YUVout}]{\setlength{\rightskip}{0pt plus 5cm}int theora\_\-decode\_\-YUVout (
\begin{DoxyParamCaption}
\item[{{\bf theora\_\-state} $\ast$}]{ th, }
...
\subsubsection[{theora\_\-encode\_\-YUVin}]{\setlength{\rightskip}{0pt plus 5cm}int theora\_\-encode\_\-YUVin (
\begin{DoxyParamCaption}
\item[{{\bf theora\_\-state} $\ast$}]{ t, }
\item[{{\bf yuv\_\-buffer} $\ast$}]{ yuv}
\end{DoxyParamCaption}
