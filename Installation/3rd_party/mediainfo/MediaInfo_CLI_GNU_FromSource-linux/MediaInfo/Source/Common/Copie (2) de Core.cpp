...
size_t Core::Menu_File_Open_Files_Continue (const String &FileName)
{
    ...
    do
    {
        ...
        if (Result&2 && !CanWrite_OnlyIfParsingIsOk)
        {
            ...
            To_Buffer_2_Pos=Ztring(MI.Option(_T("File_Duplicate"), To_Buffer_2_Name+_T(";program_number=")+ProgramNumber2)).To_int32u(); //"memory://pointer:size;program_number=..."
        }
        ...
        if (CanWrite_OnlyIfParsingIsOk)
        {
            ...
            size_t To_Buffer_Size_2=MI.Output_Buffer_Get(To_Buffer_2_Pos);
        ...
        if (Size_Parsed!=(ZenLib::int64u)-1)
        {
            ...
            if (Size_Parsed>60*1024*1024)
            {
                ...
                //Registering for duplication
                MI.Option(_T("File_Duplicate"), To_Buffer_1_Name+_T(";program_number=")+ProgramNumber2); //"memory://pointer:size;program_number=..."
