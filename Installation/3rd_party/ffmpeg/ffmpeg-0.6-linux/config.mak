...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-gpl --enable-version3 --enable-nonfree --disable-ffplay --disable-ffserver --extra-cflags='-I${LOCAL_PREFIX}/include' --extra-ldflags='-L${LOCAL_PREFIX}/lib -Wl,-rpath,${LOCAL_PREFIX}/lib' --enable-libxvid --extra-libs=-lxvidcore --enable-libx264 --extra-libs='-lx264 -lpthread' --enable-libmp3lame --extra-libs=-lmp3lame --enable-libfaad --extra-libs=-lfaad --enable-libfaac --extra-libs=-lfaac --enable-libvorbis --extra-libs=-lvorbis --enable-libtheora --extra-libs=-ltheora --enable-runtime-cpudetect
prefix=/usr/local
...
SRC_PATH="/opt/matterhorn/1.1.0/docs/scripts/3rd_party/ffmpeg/ffmpeg-0.6-linux"
SRC_PATH_BARE=/opt/matterhorn/1.1.0/docs/scripts/3rd_party/ffmpeg/ffmpeg-0.6-linux
BUILD_ROOT="/opt/matterhorn/1.1.0/docs/scripts/3rd_party/ffmpeg/ffmpeg-0.6-linux"
ARCH=x86
CC=gcc
AS=gcc
LD=gcc
...
CFLAGS= -I/usr/local/include  -std=c99 -fomit-frame-pointer -g -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit -Werror=missing-prototypes
ASFLAGS= -I/usr/local/include  -g
CC_O=-o $@
LDFLAGS=  -L/usr/local/lib -Wl,-rpath,/usr/local/lib -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
...
EXTRALIBS= -lxvidcore -lx264 -lpthread -lmp3lame -lfaad -lfaac -lvorbis -ltheora  -lz -lbz2 -lm -lfaac -lfaad -lmp3lame -lm -ltheoraenc -ltheoradec -logg -lvorbisenc -lvorbis -logg -lx264 -lm -lxvidcore -lasound -lasound -lasound
INSTALL=install
LIBTARGET=
